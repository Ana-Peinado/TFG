...
df = pd.read_csv('/Users/Propietario/Desktop/TFG/03 Weak Coverage.csv')

to_drop = [col for col in df.columns if 'masterUsers' in col or 'Distance' in col]
df.drop(columns=to_drop, inplace=True)

quantiles = df.quantile([low_quantile, high_quantile])

dff = pd.read_csv('/Users/Propietario/Desktop/TFG/03 Weak Coverage.csv',  
...
frequent_itemsets = apriori(binary_df, min_support=0.6, use_colnames=True)
